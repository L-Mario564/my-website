...
export const websites: Website[] = [
  ...
  },
  {
    ...
    description:
      'Website for managing everything related to the Eclipse Open series of osu! tournaments. The tournament and the site were cancelled.',
    img: {
  ...
  },
  {
    ...
    description:
      'Information, player registration and team management site for the 5WC 2024 osu! tournament. I was the lead developer of the frontend team.',
...
export const oss: OSSProject[] = [
  ...
  },
  {
    ...
    name: 'Lucia',
    description:
      'Auth library written in TypeScript that abstracts away the complexity of handling sessions.',
